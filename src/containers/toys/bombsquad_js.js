...
var BSQUAD = {
    ...
    this.controls = makeEle('div', {
      ...
      dom: [
        ...
        makeEle('div', {
          dom: [
            makeEle('div', {
              className: 'bs_headInfo',
              dom: [
                makeEle('div', { className: 'bs_dispHead', text: 'Bombs:' }),
                makeEle('input', {
                  className: 'bs_dispInp',
                  id: 'bs_notFlagged',
                  value: BSQUAD.numBombs,
                }),
              ],
            }),
            makeEle('div', {
  ...
  win: function () {
    ...
    this.resetflash = setInterval(function () {
      ...
      if (rb.className.indexOf('bs_flasher') > -1)
        rb.className = rb.className.replace(' bs_flasher', '');
...
BSQUAD.Square.prototype.init = function () {
  ...
  this.ele = makeEle('div', {
    ...
    height: sqs - 1 + 'px',
    width: sqs - 1 + 'px',
    fontSize: Math.round(sqs * 0.75) + 'px',
    cattr: { sq: this },
  ...
  this.ele.oncontextmenu = function () {
    return false;
  };
